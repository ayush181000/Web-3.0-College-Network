...
if "templates" not in __name__:
    ...
    sp.add_compilation_target("Token", FA2(
        ...
        metadata = sp.big_map({
            ...
            "content": sp.utils.bytes_of_string("""{"name": "MAIT Achievemnets NFTs" , "description : Verified Acievements of MAIT" , "version" : "FA2" , "author" : "Ayush&Deepanshu" , "homepage" : "https://maitcoin.netlify.app/" , "interfaces" : "https://gitlab.com/tezos/tzip/-/tree/master/proposals/tzip-16" }"""),
        })
    ))