...
TZIP16_Metadata_Base = {
    "name"          : "MAIT Coin",
    "description"   : "A Coin to promote decentralisation in MAIT",
    "authors"       : ["Ayush Garg" , "Deepanshu Jain"],
    "homepage"      : "https://maitcoin.netlify.app/"
}
    ...
    def test():
        ...
        FA12(
            ...
            token_metadata = {
                ...
                # Extra fields
                "icon"        : 'https://github.com/ayush181000/Web3.0-College-Network/blob/main/Mait_logo_1x.png'
            },
            contract_metadata = {
