...
def test():
    ...
    sp.add_compilation_target("Token", NFT(
        ...
        metadata = sp.big_map({
            "": sp.utils.bytes_of_string("tezos-storage:content"),
            "content": sp.utils.bytes_of_string("""{"name": "MAIT Canteen NFT" , "description : A FA2 Contract that stores the NFT's minted for Canteen" , "version" : "FA2" , "author" : "ayush&deepanshu" , "homepage" : "https://maitcoin.netlify.app/" , "interfaces" : "https://gitlab.com/tezos/tzip/-/tree/master/proposals/tzip-16" }"""),
        })
    ))
