...
class MAITCoinCrowdsale(sp.Contract):
    def __init__(self,_admin,_tokenAddress):   
        self.init(
            ...
            "content": sp.utils.bytes_of_string("""{"name": "MaitCoin Distributor" , "description : Distributor contract for MAITCoin to disburse tokens to students" , "admin" : "tz1NaGu7EisUCyfJpB16ktNxgSqpuMo8aSEk" , "author" : "ayush&deepanshu" , "homepage" : "https://maitcoin.netlify.app/"}"""),
        })
...
def test():
    ...
    coin = FA12.FA12(
            ...
            token_metadata = {
                ...
                "name"        : "MAIT Coin", # Recommended
                "symbol"      : "MAIT",            # Recommended
                # Extra fields
                "icon"        : 'https://github.com/ayush181000/CollegeNetwork/blob/master/Mait_logo_1x.png'
            },
            contract_metadata = {
    ...
    sp.add_compilation_target("CoinDistributor", MAITCoinCrowdsale(
